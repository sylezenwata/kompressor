 ...
 var Kompressor = /*#__PURE__*/function () {
   ...
   function Kompressor(_ref) {
     var image = _ref.image,
         ...
         imageWidth = _ref$imageWidth === void 0 ? 193 : _ref$imageWidth,
         _ref$imageHeight = _ref.imageHeight,
         imageHeight = _ref$imageHeight === void 0 ? 193 : _ref$imageHeight,
         ...
         reduceQuality = _ref$reduceQuality === void 0 ? false : _ref$reduceQuality,
         _ref$validExtensionAr = _ref.validExtensionArray,
         validExtensionArray = _ref$validExtensionAr === void 0 ? ['jpg', 'jpeg', 'png'] : _ref$validExtensionAr;
   ...
   _createClass(Kompressor, [{
     ...
     value: function validateExtension() {
       ...
       this.isValidExtension = 'object' === _typeof(this.validExtensionArray) ? this.validExtensionArray.filter(function (e) {
         return e.toLowerCase() === _this2.imageExtension.toLowerCase();
       }).length > 0 ? true : false : true;
     }
     /**
     ...
     value: function compressImage() {
       ...
       if (!this.isValidExtension) {
         var res = this.setResponse({
           error: {
             type: 'extension',
             msg: "\"".concat(this.imageExtension, "\" is not a valid image extension type in \"").concat(this.validExtensionArray.join(', '), "\"")
           }
         });
       ...
       reader.onload = function (e) {
         ...
         image.onload = function () {
           ...
           var contextWidth = _this3.imageWidth ? _this3.imageWidth : image.naturalWidth;
           var contextHeight = _this3.imageHeight ? _this3.imageHeight : image.naturalHeight; // create canvas and props
           ...
           if (_this3.returnBlob) {
             ...
             return _this3.callback ? _this3.callback(_res) : _res;
           }
           ...
           return _this3.callback ? _this3.callback(res) : res;
         };
